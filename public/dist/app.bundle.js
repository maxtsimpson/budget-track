...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _populate__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./populate */ \"./public/assets/js/populate.js\");\n/* harmony import */ var _sendTransaction__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./sendTransaction */ \"./public/assets/js/sendTransaction.js\");\n\n\n\nif (\"serviceWorker\" in navigator) {\n  window.addEventListener(\"load\", function () {\n    navigator.serviceWorker.register(\"service-worker.js\").then(function (reg) {\n      console.log(\"We found your service worker file!\", reg);\n    });\n  });\n}\n\nfetch(\"/api/transaction\").then(function (response) {\n  return response.json();\n}).then(function (data) {\n  // save db data on global variable\n  var transactions = data;\n  Object(_populate__WEBPACK_IMPORTED_MODULE_0__[\"populateTotal\"])(transactions);\n  Object(_populate__WEBPACK_IMPORTED_MODULE_0__[\"populateTable\"])(transactions);\n  Object(_populate__WEBPACK_IMPORTED_MODULE_0__[\"populateChart\"])(transactions);\n});\n\ndocument.querySelector(\"#add-btn\").onclick = function () {\n  Object(_sendTransaction__WEBPACK_IMPORTED_MODULE_1__[\"sendTransaction\"])(true);\n};\n\ndocument.querySelector(\"#sub-btn\").onclick = function () {\n  Object(_sendTransaction__WEBPACK_IMPORTED_MODULE_1__[\"sendTransaction\"])(false);\n};\n\n//# sourceURL=webpack:///./public/assets/js/index.js?");

/***/ }),

/***/ "./public/assets/js/populate.js":
/*!**************************************!*\
  !*** ./public/assets/js/populate.js ***!
  \**************************************/
